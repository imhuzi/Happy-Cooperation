        ...
        **/        
        ...
        submit: function(e) {
            ...
            .done($.proxy(function(response) {
                ...
                var res = typeof this.options.success === 'function' ? this.options.success.call(this.options.scope, response, newValue) : response;
...
(function ($) {
    ...
    //buttons
    $.fn.editableform.buttons = '<button type="submit" class="btn btn-primary editable-submit btn-small">确定</button>'+
                                '<button type="button" class="btn editable-cancel  btn-small">取消</button>';         
