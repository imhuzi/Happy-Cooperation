...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/assets/css/site.main.css"></link>
    </head>
    <body>
        <%@include file="comm/_gheader.jsp" %>
        <div class="container">
            <div class="col-xs-8">
                <ul class="media-list">
                    <li class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in
